...
public class BeerToLagerProcessor implements Processor {

    @Override
    public void process(Exchange exchange) throws Exception {
        exchange.getIn().setBody(BeerMapper.INSTANCE.largerToBitter(exchange.getIn().getMandatoryBody(Lager.class)));
    }
}
